...
public class LPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		LovecraftPixelDungeon.instance.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				LovecraftPixelDungeon.updateSystemUI();
			}
		} );
	}
	...
	public static void landscape( boolean value ){
		...
		((LovecraftPixelDungeon) LovecraftPixelDungeon.instance).updateDisplaySize();
	}
	...
	public static String toolbarMode() {
		return getString(KEY_BARMODE, !LPDSettings.landscape() ? "SPLIT" : "GROUP");
	}
