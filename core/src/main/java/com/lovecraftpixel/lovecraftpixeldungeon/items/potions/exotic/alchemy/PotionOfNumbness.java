...
import com.lovecraftpixel.lovecraftpixeldungeon.actors.buffs.Barrier;
...
public class PotionOfNumbness extends ExoticPotion {
    ...
    public void apply(Hero hero) {
        setKnown();
        Buff.append(hero, Vertigo.class, Vertigo.DURATION);
        Buff.affect(hero, Barrier.class).setShield((int)(0.6f*hero.HT + 20));
    }
}
