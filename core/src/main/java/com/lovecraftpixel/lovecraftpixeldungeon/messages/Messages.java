...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.lovecraftpixel.lovecraftpixeldungeon.messages.actors.actors",
			"com.lovecraftpixel.lovecraftpixeldungeon.messages.items.items",
			"com.lovecraftpixel.lovecraftpixeldungeon.messages.journal.journal",
			"com.lovecraftpixel.lovecraftpixeldungeon.messages.levels.levels",
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.lovecraftpixel.lovecraftpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
