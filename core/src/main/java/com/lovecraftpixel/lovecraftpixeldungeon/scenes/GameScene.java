...
import com.lovecraftpixel.lovecraftpixeldungeon.effects.CircleArc;
...
import com.lovecraftpixel.lovecraftpixeldungeon.items.bags.MagicalHolster;
...
import com.lovecraftpixel.lovecraftpixeldungeon.sprites.DiscardedItemSprite;
...
import com.lovecraftpixel.lovecraftpixeldungeon.tiles.RaisedTerrainTilemap;
...
import com.lovecraftpixel.lovecraftpixeldungeon.windows.WndBag.Mode;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		LPDSettings.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + LPDSettings.zoom(), maxZoom));
		...
		if (InterlevelScene.mode != InterlevelScene.Mode.NONE) {
			if (Dungeon.depth == Statistics.deepestFloor
			    ...
			    if(Dungeon.depth == 1000){
                    GLog.h(Messages.get(this, "return_overworld"), Dungeon.depth);
                } else {
	...
	public static void layoutTags() {
		...
		float tagLeft = LPDSettings.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (LPDSettings.flipTags()) {
