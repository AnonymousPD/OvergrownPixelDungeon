...
import com.lovecraftpixel.lovecraftpixeldungeon.windows.WndStartGame;
...
public class WelcomeScene extends PixelScene {
	...
	private static int LATEST_UPDATE = LovecraftPixelDungeon.v0_7_1;
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				if (previousVersion == 0){
					LPDSettings.version(LovecraftPixelDungeon.versionCode);
	...
	private void updateVersion(int previousVersion){
		...
		if (previousVersion <= LovecraftPixelDungeon.v0_7_0c){
			Badges.loadGlobal();
		...
		if (previousVersion <= LovecraftPixelDungeon.v0_6_5c){
			Journal.loadGlobal();
		...
		if (previousVersion <= LovecraftPixelDungeon.v0_6_2e){
		...
		if (previousVersion <= LovecraftPixelDungeon.v0_6_0b){
