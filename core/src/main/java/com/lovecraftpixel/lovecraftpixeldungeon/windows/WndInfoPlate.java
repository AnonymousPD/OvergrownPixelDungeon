...
public class WndInfoPlate extends WndTitledMessage {
	...
	public WndInfoPlate(PressurePlate plate) {

		super(TerrainFeaturesTilemap.tile( plate.pos, Dungeon.level.map[plate.pos]),
				Messages.titleCase(plate.name), plate.desc());
