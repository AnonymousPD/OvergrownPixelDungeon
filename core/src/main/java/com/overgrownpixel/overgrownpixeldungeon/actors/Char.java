...
import com.overgrownpixel.overgrownpixeldungeon.actors.blobs.Spores;
...
import com.overgrownpixel.overgrownpixeldungeon.actors.buffs.TeleportImbue;
...
import com.overgrownpixel.overgrownpixeldungeon.actors.diseases.Midease;
...
public abstract class Char extends Actor {
	...
	public enum Property{
		...
		INORGANIC ( new HashSet<Class>(),
				new HashSet<Class>( Arrays.asList(Bleeding.class, ToxicGas.class, Poison.class, Disease.class, Wither.class, Infested.class, Wither.class, Sunlight.class, Spores.class, Miasma.class, Dehydrated.class) )),
        MACHINE ( new HashSet<Class>(),
                new HashSet<Class>()),
